        ...
        <div class="rounded-t bg-white mb-0 px-6 py-6">
          ...
          <div class="grid grid-cols-12 gap-1">
            <NuxtLink
              ...
              class="2xl:col-span-4 sm:col-span-6 col-span-full p-4 mb-6 rounded-md text-gray-600 hover:border-blue-500 border-2 cursor-pointer hover:text-blue-500"
            >
            ...
            <div
              ...
              :key="item.id"
              class="2xl:col-span-4 sm:col-span-6 col-span-full p-4 mb-6 rounded-md bg-gray-50"
            >
