        ...
        <div class="w-full px-4">
          ...
          >
            <div class="rounded-t bg-white mb-0 px-6 py-6">
              <div class="text-center flex justify-between bg-darkGreen p-3">
                <h6 class="text-white text-xl font-bold">
                  รายละเอียดตัวอย่าง / Sample information
                </h6>
              </div>
                ...
                <div class="flex flex-wrap space-y-4">
                  ...
                  <div class="w-full lg:w-4/12 px-4">
                    <div class="relative w-full mb-3">
                      <label
                        class="block uppercase text-gray-600 text-xs font-bold mb-2 text-center border p-3"
                      >
                        Lab Report
                      </label>
                    </div>
                    <table class="border-collapse table-fixed w-full text-sm">
                      ...
                      <tbody class="bg-white">
                        <tr>
                          <td>
                            <input class="bg-blue-300" />
                          </td>
                          <td>
                            <input class="bg-red-300" />
                          </td>
                        </tr>
                      </tbody>
                    </table>
                  ...
                  <div class="w-full lg:w-6/12 px-4">
                    <label class="block">
                      <span class="text-gray-700"
                        >วันเริ่มการทดสอบ/ Start of DNA testing date
                      </span>
                      <input
                        type="date"
                  ...
                  <div class="w-full lg:w-6/12 px-4">
                    <label class="block">
                      <span class="text-gray-700"
                        >วันสิ้นสุดการทดสอบ/End of DNA testing date</span
                      >
                      <input
                        type="date"
                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
